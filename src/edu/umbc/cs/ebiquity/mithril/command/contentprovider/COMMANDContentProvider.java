package edu.umbc.cs.ebiquity.mithril.command.contentprovider;
...
public class COMMANDContentProvider extends ContentProvider {
	/**
	 * Forming the authority of the SPrivacy provider
	 */
	static final String PROVIDER_NAME = COMMANDApplication.getConstEbAndMWAuthority();
	static final String PROVIDER_BASE_URL = COMMANDApplication.getConstScheme() + PROVIDER_NAME;

	/**
	 * Forming the URIs for the contents that we will provide
	 */
	static final Uri IMAGES_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			COMMANDApplication.getConstSlash()+
	...
	static final Uri VIDEOS_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			COMMANDApplication.getConstSlash()+
			COMMANDApplication.getConstVideos());
	static final Uri AUDIOS_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			COMMANDApplication.getConstSlash()+
			COMMANDApplication.getConstAudios());
...
//			"#");
	...
	static{
		...
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstAndroidId(), SPrivacyQuery.ANDROID_ID);
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstImages(), SPrivacyQuery.IMAGES);
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstFiles(), SPrivacyQuery.FILES);
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstVideos(), SPrivacyQuery.VIDEOS);
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstAudios(), SPrivacyQuery.AUDIOS);

		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstCallLogs(), SPrivacyQuery.CALL_LOGS);
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstContacts(), SPrivacyQuery.CONTACTS);
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()+"lookup"
				+COMMANDApplication.getConstSlash()+"*"
				+COMMANDApplication.getConstSlash()+"#", SPrivacyQuery.CONTACTS_LOOKUP_ID);
		uriMatcher.addURI(PROVIDER_NAME, "data", SPrivacyQuery.CONTACTS_DATA);
		uriMatcher.addURI(PROVIDER_NAME, "data"+COMMANDApplication.getConstSlash()+"#", SPrivacyQuery.CONTACTS_DATA_ID);
...
//	}
	...
	private interface FakeURIsForQuery {
		Uri imageUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstImages()
				+COMMANDApplication.getConstSlash()
				+COMMANDApplication.getConstImages());
		Uri fileUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstFiles()
				+COMMANDApplication.getConstSlash()
				+COMMANDApplication.getConstFiles());
		Uri videoUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstVideos()
				+COMMANDApplication.getConstSlash()
				+COMMANDApplication.getConstVideos());
		Uri audioUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstAudios()
				+COMMANDApplication.getConstSlash()
				+COMMANDApplication.getConstAudios());
		Uri contactUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/contacts/lookup/<lookup_key>/<optional_contact_id>
		 */
		Uri contactLookupIDUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/data
		 */
		Uri contactData = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/data/<contact_id>
		 */
		Uri contactDataId = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/status_updates 
		 */
		Uri contactStatusUpdates = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/raw_contacts
		 */
		Uri contactRawContacts = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/groups
		 */
		Uri contactGroups = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstContacts()
				+COMMANDApplication.getConstSlash()
				+"groups");
		Uri callLogsUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstCallLogs()
				+COMMANDApplication.getConstSlash()
				+COMMANDApplication.getConstCallLogs());
		Uri androidIdUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstFakeAuthorityPrefix()
				+COMMANDApplication.getConstFake()
				+COMMANDApplication.getConstAndroidId()
				+COMMANDApplication.getConstSlash()
	...
	private interface AnonimyzedURIsForQuery {
		Uri imageUri = Uri.parse(COMMANDApplication.getConstScheme()
				+COMMANDApplication.getConstAnonymizedAuthorityPrefix()
...
//				} while(c.moveToNext());
//			}
			Log.v(COMMANDApplication.getDebugTag(), "Real URI: "+realURI.toString());
		}
		else {
...
//				Media.setUri(getFakeUri(provider));
				Log.v(COMMANDApplication.getDebugTag(), "Fake URI: "+fakeURI.toString());
			}
			else {
				c = getContext().getContentResolver()
						.query(anonimyzedURI,
...
//				Media.setUri(getAnonymousUri(provider));
				Log.v(COMMANDApplication.getDebugTag(), "Anonymized URI: "+anonimyzedURI.toString());
			}
		}
		return c;
	}
	...
	public boolean onCreate() {
		...
		Log.v(COMMANDApplication.getDebugTag(), CONTACTS_CONTENT_URI.toString());
		Log.v(COMMANDApplication.getDebugTag(), CONTACTS_LOOKUP_ID_URI.toString());
		Log.v(COMMANDApplication.getDebugTag(), CONTACTS_DATA_URI.toString());
		Log.v(COMMANDApplication.getDebugTag(), CONTACTS_STATUS_UPDATES_URI.toString());
		Log.v(COMMANDApplication.getDebugTag(), CONTACTS_RAW_CONTACTS_URI.toString());
		Log.v(COMMANDApplication.getDebugTag(), CONTACTS_GROUPS_URI.toString());
...
//		}
	...
	private Cursor setAndroidIdData(Uri uri, String[] projection, String selection, 
		...
		Log.v(COMMANDApplication.getDebugTag(), "URI: "+uri.toString());
