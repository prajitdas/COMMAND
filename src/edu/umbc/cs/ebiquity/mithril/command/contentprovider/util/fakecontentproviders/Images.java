...
public class Images extends ContentProvider {
	...
	static{
		...
		uriMatcher.addURI(PROVIDER_NAME, COMMANDApplication.getConstImages(), IMAGES);
	}
...
//		    String root = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS).toString();
		    ...
		    Log.v(COMMANDApplication.getDebugTag(), myDir.getAbsolutePath());
//		    myDir.mkdirs();
...
//		selectionArgs, null, null, sortOrder);
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		if(row > 0) {
			...
			Log.v(COMMANDApplication.getDebugTag(), "URI is: "+newUri.toString());
			return newUri;
		}
