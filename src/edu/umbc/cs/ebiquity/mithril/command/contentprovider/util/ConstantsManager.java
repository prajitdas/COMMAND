package edu.umbc.cs.ebiquity.mithril.command.contentprovider.util;
...
public class ConstantsManager {
	public static Uri getLookupUri(Context context, long id, String lookupKey) {
		Log.v(COMMANDApplication.getDebugTag(), "Came here and no error yet!");
		setContext(context);
...
//		String URL = "content://com.prajitdas.sprivacy.fakecontentprovider.Content.fakecontacts/contacts/"+lookupKey;
		...
		if (!c.moveToFirst()) {
			Log.v(COMMANDApplication.getDebugTag(), "Came here and no error?");
			return false;
		}
		else {
