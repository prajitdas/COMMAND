...
public class DisplayAllServicesActivity extends Activity {
	private ArrayList<HashMap<String, String>> listOfServices;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listOfServices = new ArrayList<HashMap<String, String>>();

		mapFrom = new String[] {labelData, detailData};
		mapTo = new int[] {R.id.labelData, R.id.detailData};

		for(ServInfo aService : db.findAllServices(database)) {
			HashMap<String, String> tempMap = new HashMap<String, String>();
			tempMap.put(labelData, aService.getServiceLabel());
			tempMap.put(detailData, aService.getServiceName());
			listOfServices.add(tempMap);
		}
	    Collections.sort(listOfServices, new Comparator<HashMap< String,String >>() {
