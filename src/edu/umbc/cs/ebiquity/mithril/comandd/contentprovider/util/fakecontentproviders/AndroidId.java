	...
	*/
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			Log.v(EbAndMWApplication.getDebugTag(), CONTENT_URI.toString());
		...
		private int loadDefaultData(SQLiteDatabase db) {
			...
			try{
				...
				Log.v(EbAndMWApplication.getDebugTag(), "came into exception for AndroidId!");
	            return -1;
			}
			return 1;
		}
...
//		selectionArgs, null, null, sortOrder);
		...
		*/
		...
		cursor.moveToFirst();
		Log.v(EbAndMWApplication.getDebugTag(), Long.toHexString(Long.parseLong(cursor.getString(1))));
		return cursor;
	}
