package edu.umbc.cs.ebiquity.mithril.comandd.contentprovider;
...
public class EbAndMWContentProvider extends ContentProvider {
	...
	static final Uri IMAGES_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			EbAndMWApplication.getConstSlash()+
			EbAndMWApplication.getConstImages());
	static final Uri FILES_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			EbAndMWApplication.getConstSlash()+
			EbAndMWApplication.getConstFiles());
	static final Uri VIDEOS_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			EbAndMWApplication.getConstSlash()+
			EbAndMWApplication.getConstVideos());
	...
	static final Uri CONTACTS_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			EbAndMWApplication.getConstSlash()+
			EbAndMWApplication.getConstContacts());
...
//			"#");
	...
	static final Uri CALL_LOGS_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			EbAndMWApplication.getConstSlash()+
			EbAndMWApplication.getConstCallLogs());
	static final Uri ANDROID_ID_CONTENT_URI = Uri.parse(PROVIDER_BASE_URL+
			EbAndMWApplication.getConstSlash()+
			EbAndMWApplication.getConstAndroidId());
	...
	static{
		...
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstAndroidId(), SPrivacyQuery.ANDROID_ID);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstImages(), SPrivacyQuery.IMAGES);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstFiles(), SPrivacyQuery.FILES);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstVideos(), SPrivacyQuery.VIDEOS);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstAudios(), SPrivacyQuery.AUDIOS);

		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstCallLogs(), SPrivacyQuery.CALL_LOGS);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstContacts(), SPrivacyQuery.CONTACTS);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()+"lookup"
				+EbAndMWApplication.getConstSlash()+"*"
				+EbAndMWApplication.getConstSlash()+"#", SPrivacyQuery.CONTACTS_LOOKUP_ID);
		uriMatcher.addURI(PROVIDER_NAME, "data", SPrivacyQuery.CONTACTS_DATA);
		uriMatcher.addURI(PROVIDER_NAME, "data"+EbAndMWApplication.getConstSlash()+"#", SPrivacyQuery.CONTACTS_DATA_ID);
	...
	*/
	...
	private interface FakeURIsForQuery {
		Uri imageUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstImages()
				+EbAndMWApplication.getConstSlash()
				+EbAndMWApplication.getConstImages());
		Uri fileUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstFiles()
				+EbAndMWApplication.getConstSlash()
				+EbAndMWApplication.getConstFiles());
		Uri videoUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstVideos()
				+EbAndMWApplication.getConstSlash()
				+EbAndMWApplication.getConstVideos());
		Uri audioUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstAudios()
				+EbAndMWApplication.getConstSlash()
				+EbAndMWApplication.getConstAudios());
		Uri contactUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/contacts/lookup/<lookup_key>/<optional_contact_id>
		 */
		Uri contactLookupIDUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/data
		 */
		Uri contactData = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/data/<contact_id>
		 */
		Uri contactDataId = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/status_updates 
		 */
		Uri contactStatusUpdates = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/raw_contacts
		 */
		Uri contactRawContacts = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()
		 ...
		 * The form is: content://com.android.contacts/groups
		 */
		Uri contactGroups = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstContacts()
				+EbAndMWApplication.getConstSlash()
				+"groups");
		Uri callLogsUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstCallLogs()
				+EbAndMWApplication.getConstSlash()
				+EbAndMWApplication.getConstCallLogs());
		Uri androidIdUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstFakeAuthorityPrefix()
				+EbAndMWApplication.getConstFake()
				+EbAndMWApplication.getConstAndroidId()
				+EbAndMWApplication.getConstSlash()
	...
	private interface AnonimyzedURIsForQuery {
		Uri imageUri = Uri.parse(EbAndMWApplication.getConstScheme()
				+EbAndMWApplication.getConstAnonymizedAuthorityPrefix()
				+EbAndMWApplication.getConstAnnonymous()
				+EbAndMWApplication.getConstImages()
				+EbAndMWApplication.getConstSlash()
				+EbAndMWApplication.getConstImages());
		Uri fileUri = Uri.parse(EbAndMWApplication.getConstScheme()
...
//		Log.v(EbAndMWApplication.getDebugTag(), "Came into data control! with projection as follows"); 
//		if(projection!=null)
//			for(String p:projection)
//				Log.v(EbAndMWApplication.getDebugTag(), "data: "+p);
//		Log.v(EbAndMWApplication.getDebugTag(), "sort order "+ sortOrder);
		Cursor c = null;
...
//				} while(c.moveToNext());
//			}
			Log.v(EbAndMWApplication.getDebugTag(), "Real URI: "+realURI.toString());
		}
		else {
...
//				Media.setUri(getFakeUri(provider));
				Log.v(EbAndMWApplication.getDebugTag(), "Fake URI: "+fakeURI.toString());
			}
			else {
				c = getContext().getContentResolver()
						.query(anonimyzedURI,
...
//				Media.setUri(getAnonymousUri(provider));
				Log.v(EbAndMWApplication.getDebugTag(), "Anonymized URI: "+anonimyzedURI.toString());
			}
		}
		return c;
	}
	...
	@Override
	public boolean onCreate() {
		Log.v(EbAndMWApplication.getDebugTag(), IMAGES_CONTENT_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), FILES_CONTENT_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), VIDEOS_CONTENT_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), AUDIOS_CONTENT_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), CONTACTS_CONTENT_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), CONTACTS_LOOKUP_ID_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), CONTACTS_DATA_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), CONTACTS_STATUS_UPDATES_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), CONTACTS_RAW_CONTACTS_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), CONTACTS_GROUPS_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), CALL_LOGS_CONTENT_URI.toString());
		Log.v(EbAndMWApplication.getDebugTag(), ANDROID_ID_CONTENT_URI.toString());
...
//		if (c.moveToFirst()) {
//			do {
//				Log.v(EbAndMWApplication.getDebugTag(), "id: "+c.getString(0));
//				Log.v(EbAndMWApplication.getDebugTag(), "mimetype: "+c.getString(1));
//				Log.v(EbAndMWApplication.getDebugTag(), "data_version: "+c.getString(2));
//				Log.v(EbAndMWApplication.getDebugTag(), "is_primary: "+c.getString(3));
//				Log.v(EbAndMWApplication.getDebugTag(), "is_super_primary: "+c.getString(4));
//				Log.v(EbAndMWApplication.getDebugTag(), "raw_contact_id: "+c.getString(6));
//				Log.v(EbAndMWApplication.getDebugTag(), "data1: "+c.getString(7));
//				Log.v(EbAndMWApplication.getDebugTag(), "data2: "+c.getString(8));
//				Log.v(EbAndMWApplication.getDebugTag(), "data3: "+c.getString(9));
//				Log.v(EbAndMWApplication.getDebugTag(), "data4: "+c.getString(10));
//				Log.v(EbAndMWApplication.getDebugTag(), "data5: "+c.getString(11));
//				Log.v(EbAndMWApplication.getDebugTag(), "data6: "+c.getString(12));
//				Log.v(EbAndMWApplication.getDebugTag(), "data7: "+c.getString(14));
//				Log.v(EbAndMWApplication.getDebugTag(), "data9: "+c.getString(15));
//				Log.v(EbAndMWApplication.getDebugTag(), "data10: "+c.getString(16));
//				Log.v(EbAndMWApplication.getDebugTag(), "data14: "+c.getString(17));
//			} while (c.moveToNext());
//		}
		...
		Log.d(EbAndMWApplication.getDebugTag(), "Broadcast being sent!");
	...
	private Cursor setAndroidIdData(Uri uri, String[] projection, String selection, 
		...
		Log.v(EbAndMWApplication.getDebugTag(), "URI: "+uri.toString());
