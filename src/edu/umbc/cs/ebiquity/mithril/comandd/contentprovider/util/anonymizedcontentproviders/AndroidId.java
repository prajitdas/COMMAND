package edu.umbc.cs.ebiquity.mithril.comandd.contentprovider.util.anonymizedcontentproviders;
...
public class AndroidId extends ContentProvider {
	static final String PROVIDER_NAME = EbAndMWApplication.getConstAnonymizedAuthorityPrefix()
	...
	static{
		...
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstAndroidId(), ANDROID_ID);
	}
