package edu.umbc.cs.ebiquity.mithril.comandd.contentprovider.util;
...
public class ConstantsManager {
	public static Uri getLookupUri(Context context, long id, String lookupKey) {
		Log.v(EbAndMWApplication.getDebugTag(), "Came here and no error yet!");
		setContext(context);
...
//		String URL = "content://com.prajitdas.sprivacy.fakecontentprovider.Content.fakecontacts/contacts/"+lookupKey;
		...
		if (!c.moveToFirst()) {
			Log.v(EbAndMWApplication.getDebugTag(), "Came here and no error?");
			return false;
		}
		else {
