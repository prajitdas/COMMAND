...
public class Contacts extends ContentProvider {
	...
	static{
		...
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstContacts(), CONTACTS);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstContacts()+"/#", CONTACTS_ID);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstContacts()+"/#/data", CONTACTS_ID_DATA);
		uriMatcher.addURI(PROVIDER_NAME, EbAndMWApplication.getConstContacts()
				...
				+EbAndMWApplication.getConstSlash()+"#", CONTACTS_LOOKUP_ID);
		uriMatcher.addURI(PROVIDER_NAME, "data", CONTACTS_DATA);
		uriMatcher.addURI(PROVIDER_NAME, "data"+EbAndMWApplication.getConstSlash()+"#", CONTACTS_DATA_ID);
	...
	*/
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			Log.v(EbAndMWApplication.getDebugTag(), "came into onCreate for Contacts!");
			loadDefaultData(db);
		}
...
//				Log.v(EbAndMWApplication.getDebugTag(), "came into loadDefaultData for Contacts!");
				...
				Log.v(EbAndMWApplication.getDebugTag(), "came into exception for Contacts!");
	            return -1;
			}
			values.clear();
